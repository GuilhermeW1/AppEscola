...
public class TelaUsuarios extends javax.swing.JFrame {
    ...
    public void limparTela() {
        ...
        jC_Bairros_telausuarios.setSelectedIndex(0);
    }
    ...
    private Usuario guardarDados() {
        try {
            ...
            objeto.setId_bairros(cod_bairro);
            System.out.println("Dentro de guardar dados " +cod_bairro);
            return objeto;
        } catch (Exception e) {
    ...
    */
    private Usuario guardarDadosUpdate() {
        try {
            ...
            int cod_bairro = Integer.parseInt(c.getCodigo());
            objeto.setId_bairros(cod_bairro);
            System.out.println("Dentro de guardar dados update " +cod_bairro);
            return objeto;
    ...
    private void preencherCampos(Usuario objeto) {
        try {
            ...
            txtNome_tela_usuario.setText(objeto.getNome());
             ...
             comboBairros.SetaComboBox(String.valueOf(objeto.getId_bairros()));
        } catch (Exception e) {
